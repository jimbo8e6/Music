    ...
    <header className="border-ink-800 bg-ink-950/85 sticky top-0 z-20 border-b backdrop-blur">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="flex items-center gap-x-4 py-3">
          ...
          {username && userId ? (
            <div className="text-mist-300 ml-auto flex items-center gap-3 text-sm sm:ml-0">
              {/* Desktop: @username | divider | bell | search | sign out */}
              <Link
              ...
              <span className="border-ink-700 hidden h-4 border-l sm:block" aria-hidden />
