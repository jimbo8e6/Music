...
export function NotificationBell({ initialItems }: { initialItems: NotificationItem[] }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="bg-ink-900 border-ink-700 absolute right-0 top-full z-50 mt-2 w-80 max-w-[calc(100vw-1rem)] overflow-hidden rounded-lg border shadow-xl sm:right-auto sm:left-1/2 sm:-translate-x-1/2">
